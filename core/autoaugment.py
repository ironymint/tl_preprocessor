...
def distort_image_with_autoaugment_batch(images, augmentation_name):
  ...
  for image in images:
    ...
    print(build_and_apply_nas_policy(policy, image, augmentation_params))

    augmented.append(build_and_apply_nas_policy(policy, image, augmentation_params))
